                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <p>5. Save as this file with .txt extension and change the encoding : <strong>UTF-8</strong>.</p>
                                <p>6. Change the file extension .txt to .csv.</p>
                                <p>7. Now this file use import question.</p>
                                <p>&nbsp;&nbsp;<a href="https://www.ablebits.com/office-addins-blog/2014/04/24/convert-excel-csv/" target="_blank" class="text-dark">For more info</a></p>
                            </div>
