                                    ...
                                    <form id="system_configurations_form" method="POST" data-parsley-validate="" class="form-horizontal form-label-left">
                                        ...
                                        <div class="col-md-4 col-xs-12 adsHide">
                                                ...
                                                <div id="status" class="btn-group">
                                                    ...
                                                    <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                                    <input type="radio"  name="ads_type" value="3" required  <?php
                                                                     if (!empty($data['ads_type']) && $data['ads_type'] == '3') {
                                                                        echo 'checked';
                                                                    }
                                                                    ?>> Unity Ads.
                                                                </label>                                                       
                                        ...
                                        <div class="adsunity"> 
                                                    <div class="form-group row">
                                                        <div class="col-md-6 col-sm-12">
                                                            ...
                                                            <input type="text" id="android_game_id" name="android_game_id" class="form-control unityAtt" value="<?php echo ($data['android_game_id'] != "") ? $data['android_game_id'] : "" ?>">
                                                        </div>
