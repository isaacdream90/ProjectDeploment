                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li>
                                <a><em class="fas fa-trophy"></em> Questions<span class="fas fa-caret-down"></span></a>
                                <ul class="nav child_menu">
					        ...
					        <li><a href="payment-requests.php"><i class="fas fa-rupee-sign"></i> Payment Requests</a></li>
