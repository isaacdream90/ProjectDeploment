                                ...
                                <div class="x_content">
                                    <form id="custom_coin_form" method="POST" action ="db_operations.php"data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    <label class="" for="app_link">Daily Maximum Spin Limit</label>
                                                    <input type="number" min="0"  id="daily_max_spin_limit" name="daily_max_spin_limit" required="required" class="form-control col-md-12 col-xs-12" value="<?php echo ($data['daily_max_spin_limit'] != "") ? $data['daily_max_spin_limit'] : "" ?>">
                                                </div>

                                            </div>
                                             <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    <label class="" for="app_link">More Spin Coin</label>
                                                    <input type="number" min="0" id="more_spin_coin" name="more_spin_coin" required="required" class="form-control col-md-12 col-xs-12" value="<?php echo ($data['more_spin_coin'] != "") ? $data['more_spin_coin'] : "" ?>">
                                                   
                                                </div>
                                                <small>Spin daily limit used then after you can spin using coin</small>
                                            </div>
